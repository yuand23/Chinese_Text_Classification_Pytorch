...
def get_labels_dict(labels_set={}): # 如果为空则读取，否则保存
    ...
    if len(labels_set) > 0:
        ...
        with open(os.path.join(MODEL_SAVE,"labels_dict.txt"), "r") as f_idx2tag: # 格式为index:tag 样本数
...
def train():
    ...
    for epoch in range(EPOCHS):
        ...
        val_loss_sum_lst.append(val_loss_sum/len(val_dataset))
